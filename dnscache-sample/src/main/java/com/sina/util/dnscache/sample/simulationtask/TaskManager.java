...
import static com.sina.util.dnscache.sample.tasksetting.Config.concurrencyNum;
import static com.sina.util.dnscache.sample.tasksetting.Config.requestsNum;
...
public class TaskManager {
    ...
    private void initThreadPool() {
        threadPool = new ThreadPool(concurrencyNum);
    }
